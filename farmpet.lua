   getgenv().Config = {
      Dashboard = {
            ...
            GroupName = "AGEPOT",   -- Group name for organising accounts on dashboard (https://zekehub.com/dashboard/adoptme)
        },
        BabyFarm = true, -- Does baby farm
        AutoCertificate = false, -- Auto use Pet Handler Pro Certificate when less than 30 days remaining
        EventFarm = {
            Fishing = {
                Enabled = false,       -- auto uses the bait and catches fish
                AutoUpgradeRod = false, -- bronze -> silver -> gold as fish count allows
                StopKarpAtMonsterGoal = false, -- Stop buying Karp Bait at 75 bronze + 35 silver + 15 gold fish (Tealwood Monster Bait). Only enable ONE goal at a time
                StopKarpAtRainbowGoal = false, -- Stop buying Karp Bait at 1 rainbow fish (Rainbow Trout). Only enable ONE goal at a time
            },
            AutoTreasureHunt = {
       ...
       AccountManager = {
            ...
            Tool = "", -- "yummy", "farmsync", "farmerv5", "kick" = kick tool means it will just kick you from the game instead of yummy or farmsync actions
            Yummy = {
        ...
        Webhook = {
            ...
            PetUnlock = {
                ...
                URL = "https://discord.com/api/webhooks/1391551758634848306/Pq9wPqBpYGQSuKY-udz_a6V81v0kLcy_w7EHx84WgSYLsHDVVJYprLM08_jMe0zo0yNX", -- Webhook URL for pet unlocks
...
getgenv().scriptkey="eKyznZJdaheTklQueGPLFDquGZbgCSjm"
