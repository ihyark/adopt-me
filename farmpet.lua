_G.GAGConfig = _G.GAGConfig or {
    ...
    ["Planting"] = {
        ...
        ["Plant Plan"]  = { ["Dragon's Breath"] = 150, ["Sun Bloom"] = 150, ["Moon Bloom"] = 150, ["Hypno Bloom"] = 150 },                 -- MAP crop = number. keep N of each planted, then auto-fill the rest. EACH crop needs a number. e.g. { Apple = 50, ["Dragon Fruit"] = 20 }
        ...
        ["Don't Buy"]   = { "Carrot", "Blueberry", "Strawberry", "Tomato", "Tulip", "Apple", "Corn", "Cactus", "Pineapple", "Banana", "Grape", "Coconut", "Mango", "Acorn" },                 -- LIST of crop names = never spend money buying these (can still plant ones you already own). e.g. { "Mango", "Coconut" }
