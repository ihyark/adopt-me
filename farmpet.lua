_G.GAGConfig = _G.GAGConfig or {
    ...
    ["Planting"] = {
        ...
        ["Plant Plan"]  = { ["Green Bean"] = 20, ["Gold"] = 100, ["Tomato"] = 20, ["Strawberry"] = 10, ["Blueberry"] = 10, ["Carrot"] = 10, ["Bamboo"] = 500, ["Mushroom"] = 500, ["Dragon's Breath"] = 100, ["Moon Bloom"] = 100, ["Hypno Bloom"] = 10 },                 -- e.g. { Apple = 50, ["Dragon Fruit"] = 20 }  (keep N planted, then auto-fill)
