_G.GAGConfig = _G.GAGConfig or {
    ...
    ["Planting"] = {
        ...
        ["Plant Plan"]  = { ["Fire Fern"] = 5, ["Poison Apple"] = 5, ["Poison Ivy"] = 5, ["Pomegranate"] = 5, ["Venom Spitter"] = 5, ["Venus Fly Trap"] = 5, ["Green Bean"] = 20, ["Gold"] = 150, ["Tomato"] = 10, ["Strawberry"] = 10, ["Blueberry"] = 10, ["Carrot"] = 10, ["Bamboo"] = 400, ["Mushroom"] = 100 },                 -- MAP crop = number. keep N of each planted, then auto-fill the rest. EACH crop needs a number. e.g. { Apple = 50, ["Dragon Fruit"] = 20 }
        ["Only Plant"]  = { "Fire Fern", "Poison Apple", "Poison Ivy", "Pomegranate", "Venom Spitter", "Venus Fly Trap", "Carrot", "Gold", "Strawberry", "Bamboo", "Mushroom", "Green Bean", "Dragon's Breath", "Moon Bloom", "Hypno Bloom", "Tomato", "Blueberry" },                 -- LIST of crop names = plant ONLY these (empty = plant anything). e.g. { "Bamboo", "Dragon Fruit" }
