_G.GAGConfig = _G.GAGConfig or {
    ...
    ["Planting"] = {
        ...
        ["Don't Buy"]   = { "Tulip", "Apple", "Corn", "Cactus", "Pineapple", "Banana", "Grape", "Coconut", "Mango", "Acorn" },                 -- LIST of crop names = never spend money buying these (can still plant ones you already own). e.g. { "Mango", "Coconut" }
