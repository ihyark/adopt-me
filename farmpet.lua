getgenv().Config = {
        ...
        AutoRecycle = {
            ...
            RarityFilter = {
                ...
                legendary = {"regular", "neon"},                   -- Only recycle mega legendaries
            },
            AgeFilter = {"3", "4", "5", "6"}, -- Empty = all ages, or specific ages e.g. {1, 2, 3, 4, 5, 6} (1=Newborn, 6=Full Grown)
            ExcludedPets = {"sugarfest_2026_gumball_caterpillar", "pet_progression_2026_purrowl", "lss_2026_glormy_crab", "pet_recycler_2025_emberlight", "admin_abuse_egg_2026_robot_chicken", "sugarfest_2026_easter_bunny", "endangered_2026_silverback_gorilla", "penguins_2025_dango_penguins", "food_pets_2026_dragonfruit_fox", "sugarfest_2026_mochi_meow"}, -- Pet IDs to never recycle e.g. {"dog", "cat", "shadow_dragon"}
        },
        IdleProgression = {
